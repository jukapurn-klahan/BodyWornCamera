...
dynamic getJsonField(dynamic response, String jsonPath, [bool isForList = false]) {
...
Theme wrapInMaterialDatePickerTheme(
  ...
  return Theme(
    data: baseTheme.copyWith(
      colorScheme: baseTheme.colorScheme.copyWith(onSurface: pickerForegroundColor),
      disabledColor: pickerForegroundColor.withOpacity(0.3),
      textTheme: baseTheme.textTheme.copyWith(headlineSmall: headerTextStyle, headlineMedium: headerTextStyle),
      iconTheme: baseTheme.iconTheme.copyWith(size: iconSize),
      textButtonTheme: TextButtonThemeData(
        style: ButtonStyle(
          foregroundColor: MaterialStatePropertyAll(actionButtonForegroundColor),
      ...
      datePickerTheme: DatePickerThemeData(
        ...
        weekdayStyle: baseTheme.textTheme.labelMedium!.copyWith(color: pickerForegroundColor),
    ...
    data: baseTheme.copyWith(
      ...
      timePickerTheme: baseTheme.timePickerTheme.copyWith(
        ...
        dialTextColor: MaterialStateColor.resolveWith(
          (states) => states.contains(MaterialState.selected) ? selectedDateTimeForegroundColor : pickerForegroundColor,
        ),
        dayPeriodBorderSide: BorderSide(color: pickerForegroundColor),
...
bool responsiveVisibility({required BuildContext context, bool phone = true, bool tablet = true, bool tabletLandscape = true, bool desktop = true}) {
...
void showSnackbar(BuildContext context, String message, {bool loading = false, int duration = 4}) {
...
extension MapFilterExtensions<T> on Map<String, T?> {
  Map<String, T> get withoutNulls => Map.fromEntries(entries.where((e) => e.value != null).map((e) => MapEntry(e.key, e.value as T)));
}
...
void fixStatusBarOniOS16AndBelow(BuildContext context) {
  ...
  if (_lastBrightness != brightness) {
    ...
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(statusBarBrightness: brightness, systemStatusBarContrastEnforced: true));
  }
}
