...
class PincodeView extends GetView<PinCodeController> {
  ...
  Widget build(BuildContext context) {
    ...
    if (data != null && data.containsKey('isNewPassword')) {
      controller.setNewPassword(data['isNewPassword']);
    }

    if (data != null && data.containsKey('isOpenProfile')) {
      controller.setOpenProfile(data['isOpenProfile']);
    }
                      ...
                      child: Container(
                        ...
                        child: PinCodeTextField(
                          ...
                          pinTheme: PinTheme(
                            ...
                            activeColor: FlutterFlowThemeNew.of(context).accent2,
                            inactiveColor: FlutterFlowThemeNew.of(context).primaryBlue,
                            selectedColor: FlutterFlowThemeNew.of(context).accent2,
                            activeFillColor: FlutterFlowThemeNew.of(context).accent2,
                            inactiveFillColor: Color(0x00E2E2E8),
                            selectedFillColor: FlutterFlowThemeNew.of(context).accent2,
                          ),
                          ...
                          itemBuilder: (context, index) {
                            return [
                              ...
                              () => Align(
                                alignment: AlignmentDirectional(0.0, 0.0),
                                child: Obx(() {
                                  if (controller.isNewPassword.value) {
                                    return Container();
                                  }
                                    ...
                                    return FFButtonWidget(
                                      ...
                                      icon: controller.isAuthenticatingBiometric.value
                                          ? SizedBox(
                                              width: 20.0,
                                              height: 20.0,
                                              child: CircularProgressIndicator(color: FlutterFlowThemeNew.of(context).primaryBlue, strokeWidth: 2.0),
                                            )
                                          : Icon(
