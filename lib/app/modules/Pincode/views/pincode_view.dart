      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: controller.isOpenProfile.value
                ? IconButton(
                    onPressed: Get.back,
            ...
            title: Text(
              ...
              style: FlutterFlowThemeNew.of(context).titleMedium.override(
                ...
                useGoogleFonts: GoogleFonts.asMap().containsKey(
                  FlutterFlowThemeNew.of(context).titleMediumFamily,
                ),
              ),
            ),
            actions: [],
                ...
                children: [
                  AnimatedContainer(
                    ...
                    transform: Matrix4.translationValues(
                      controller.pinShakeOffset.value,
                      0.0,
                      0.0,
                    ),
                    child: Align(
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: PinCodeTextField(
                                ...
                                appContext: context,
                                length: 6,
                                textStyle: FlutterFlowThemeNew.of(context)
                                    .bodySmall
                                    .override(
                                      fontFamily: FlutterFlowThemeNew.of(
                                        context,
                                ...
                                errorTextSpace: 0.0,
                                showCursor: false,
                                cursorColor: FlutterFlowThemeNew.of(
                                  context,
                                ).primaryBlue,
                                obscureText: false,
                                ...
                                pinTheme: PinTheme(
                                  ...
                                  activeColor: FlutterFlowThemeNew.of(
                                    context,
                                  ).customColor5,
                                  inactiveColor: FlutterFlowThemeNew.of(
                                    context,
                                  ).primaryBlue,
                                  selectedColor: FlutterFlowThemeNew.of(
                                    context,
                                  ).customColor5,
                                  activeFillColor: FlutterFlowThemeNew.of(
                                    context,
                                  ).customColor5,
                                  inactiveFillColor: Color(0x00E2E2E8),
                                  selectedFillColor: FlutterFlowThemeNew.of(
                                    context,
                                  ).customColor5,
                                ),
                                    ...
                                    () => Align(
                                      ...
                                      child: Obx(() {
                                        if (controller.isNewPassword.value ||
                                            !controller.hasSavedPinCode.value) {
                                          return Container();
                                        }
                                        ...
                                        return FFButtonWidget(
                                          ...
                                          options: FFButtonOptions(
                                            ...
                                            hoverColor: FlutterFlowThemeNew.of(
                                              context,
                                            ).primaryBlue,
                                            hoverTextColor:
                                                FlutterFlowThemeNew.of(
