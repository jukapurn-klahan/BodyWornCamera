...
class BTYearWidget extends StatefulWidget {
  const BTYearWidget({Key? key}) : super(key: key);

  @override
  _BTYearWidgetState createState() => _BTYearWidgetState();
}

class _BTYearWidgetState extends State<BTYearWidget> {
                ...
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            final dt = DateFormat("yyyy").format(getDateTime);
                  ...
                  Expanded(
                    child: DatePickerWidget(
                      ...
                      firstDate: getFirstYear(),
                      lastDate: getLastYear(),
